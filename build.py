...
def build_optimizer(main_params, linear_params, cluster_params, cam_params, 
    supcluster_params, supcluster_cam_params, opt: dict, model_type: str):
    # opt = opt["optimizer"]
    ...
    if "stego" in model_type:
        ...
        cam_optimizer_type = opt["cam"]["name"].lower()
        ...
        if supcluster_cam_optimizer_type == "adam":
            supcluster_cam_optimizer = Adam(supcluster_cam_params, lr=opt["supcluster_cam"]["lr"])
        else:
